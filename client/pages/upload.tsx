  ...
  if (!bundlrInstance) {
    return (
      <div className="justify-center items-center h-screen flex font-body flex-col">
        <Head>
          <title>bluebear || Initialize MATIC</title>
          <link rel="icon" href="/logo-main.png" />
        </Head>
        <h3 className="text-4xl font-bold sm:text-xl">
          Let&apos;s initialise MATIC  now 💱
        </h3>
        <button
  ...
  if (
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen ">
        <Head>
          <title>bluebear || Add Funds</title>
          <link rel="icon" href="/logo-main.png" />
        </Head>
        <h3 className="text-4xl font-body text-center">
          Oops! Before Uploading Post Please Add Some Matic Funds.🪙
        </h3>
        <FundWallet />
      </div>
    );
